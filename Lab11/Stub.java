...
public class Stub {
	...
	for(int j = 0; j < 100; j++) {
	Random r = new Random();
	String target = dictionary[(int) (Math.random() * dictionary.length)];  //dictionary[r.nextInt()];
	...
	if(lives==0){
	running=false;
	System.out.println(target + " => " + mybrain.hiddenWord);
	System.out.println(mybrain.list);
